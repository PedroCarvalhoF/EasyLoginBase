...
namespace EasyLoginBase.InfrastructureData.Migrations
{
    ...
    [Migration("20250505162625_tbl_categoria_produto_not_is_unique_nomeCategoria")]
    partial class tbl_categoria_produto_not_is_unique_nomeCategoria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyLoginBase.Domain.Entities.Produto.Estoque.MovimentacaoEstoqueProdutoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("EstoqueProdutosMovimentacao", (string)null);
                });
            ...
            modelBuilder.Entity("EasyLoginBase.Domain.Entities.Produto.Estoque.MovimentacaoEstoqueProdutoEntity", b =>
                {
                    b.HasOne("EasyLoginBase.Domain.Entities.Filial.FilialEntity", "Filial")
                        .WithMany("MovimentacaoEstoqueProdutoEntities")
                        .HasForeignKey("FilialId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("EasyLoginBase.Domain.Entities.Filial.FilialEntity", b =>
                {
                    ...
                    b.Navigation("MovimentacaoEstoqueProdutoEntities");
